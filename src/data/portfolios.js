...
const portfolios = [
    {
        ...
        link1: 'https://nirmalyo-socialmedia.herokuapp.com/',
        link2: 'https://github.com/Nirmalya-Saha96/Social-media-2.0',
        title: 'Connector',
        text: 'Social Media website for developers / HR’s to share their github commit stories, technical blogs, apply or post jobs to hire developers. Create documents and edit them with real-time server support (Google docs implementation), Contact using Private Chat Features. Create and update profile.Features includes: Chatbot, An online code editor for HTML,CSS & JAVASCRIPT. || Like/UnLike a post/blog/comment, | also comment on a post. | Post a job and apply through submitting a resume. || Personalised Dashboard to create/delete profile sections(Education,Experience,About,Skills,Projects,Links etc.) || Private Chats | Advance Alert System | Validation Checks | Encryptions | Private Routes | Create/edit documents  Technologies: React.JS, Redux,Node.JS,Express,MongoDB,Socket.io,JWT-token,Codemirror & Chatbotkit API'
    },
    {
        id: 2,
        category: 'MERN-stack',
